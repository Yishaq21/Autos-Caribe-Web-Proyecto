...
public class AuthController {
    ...
    @GetMapping("/login") // Pantalla de inicio de sesion
    public String login() {
        return "/auth/login"; 
    }
    ...
    public String procesarLogin(@RequestParam String username, 
        ...
        if ("admin".equals(username) && "admin".equals(password)) {
            ...
            // Creamos un usuario ficticio admin
            Usuario adminFicticio = new Usuario();
            adminFicticio.setUsername("admin");
            adminFicticio.setNombre("Super");
            adminFicticio.setApellidos("Administrador");
            adminFicticio.setActivo(true);
            
            // Guardamos este usuario en la sesión y forzamos el rol de admin
            session.setAttribute("usuarioLogueado", adminFicticio);
            session.setAttribute("esAdmin", true);
            
            return "redirect:/"; // Lo mandamos directo al inicio
        }        
        // Lógica normal para el resto de usuarios (busca en la BD)
